...
let listmatplus_bop e1 e2 = mk_ListNop MatPlus [e1;e2]
...
and solve_adds etbl adds = match adds with
    ...
    | (e1, e2) :: adds' ->
            ...
            | (Some i1, Some i2) -> (Some (i_bop listmatplus_bop i1 i2))
